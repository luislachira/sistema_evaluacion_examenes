...
<head>
    ...
    <title>{{ config('app.name', 'Sistema de Evaluación de Exámenes') }}</title>

    <!-- Placeholder for custom logo/favicon -->
    <!-- <link rel="shortcut icon" href="/logo.png" type="image/png"> -->
    <!-- <link rel="icon" href="/logo.png" type="image/png"> -->
    <!-- <link rel="apple-touch-icon" href="/logo.png"> -->

    <!-- Original specific logos commented out for generic repo -->
    <!--
    <link rel="shortcut icon" href="/logo_leonor_cerna 2.png?v=5" type="image/png">
    <link rel="icon" href="/logo.png?v=5" type="image/png">
    <link rel="icon" href="/logo.png?v=5" sizes="any">
